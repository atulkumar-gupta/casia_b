...
result = scipy.io.loadmat('/home/nirbhay/tharun/dg-net/st-reid/model/'+name+'/'+'pytorch_result.mat')
...
result2 = scipy.io.loadmat('/home/nirbhay/tharun/dg-net/st-reid/model/'+name+'/'+'pytorch_result2.mat')
...
scipy.io.savemat('/home/nirbhay/tharun/dg-net/st-reid/model/'+name+'/'+'CMC_m1501_two_stream_add'+str(alpha)+'.mat',result)
